    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.user && response.token) {
                ...
                console.log('User logged in, navigating...'); // Debug log
                navigate('/dashboard');
            } else {
        ...
        <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                ...
                <div className="text-center">
                    <h2 className="text-3xl font-bold text-gray-900 mb-2">Hospital personnel Login</h2>
                ...
                <div className="bg-white py-10 px-8 shadow-soft rounded-2xl border border-gray-100">
                    ...
                    <div className="mt-8 text-center space-y-4">
                        <div className="text-sm text-gray-600">
                            ...
                            >
                                Create your hospital personel account
                            </Link>
                        </div>
